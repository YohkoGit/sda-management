    ...
    <div style={{maxWidth:1200, margin:"0 auto", color:"#E8DFC9"}}>
      ...
      <DSSection n="01" eyebrow="Foundation" title="Colour">
        ...
        <div style={{marginTop:32}}>
          <div className="eyebrow" style={{color:"#8E8267", marginBottom:14}}>Department spot colours</div>
          <div style={{display:"flex", gap:18, flexWrap:"wrap"}}>
            {DEPTS.map(d => (
              <div key={d.code} style={{display:"flex", alignItems:"center", gap:10}}>
                <span style={{width:28, height:28, borderRadius:"50%", background:d.color, border:"1px solid rgba(255,255,255,0.06)"}}/>
                <div>
                  <div style={{fontFamily:"var(--font-display)", fontSize:14, color:"#E8DFC9"}}>{d.name}</div>
                  <div style={{fontFamily:"var(--font-mono)", fontSize:10, color:"#8E8267", letterSpacing:"0.12em"}}>{d.code}</div>
                </div>
              </div>
            ))}
          </div>
