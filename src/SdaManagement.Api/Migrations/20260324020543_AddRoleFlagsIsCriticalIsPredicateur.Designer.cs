...
namespace SdaManagement.Api.Migrations
{
    ...
    [Migration("20260324020543_AddRoleFlagsIsCriticalIsPredicateur")]
    partial class AddRoleFlagsIsCriticalIsPredicateur
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SdaManagement.Api.Data.Entities.ActivityRole", b =>
                {
                    ...
                    b.Property<bool>("IsPredicateur")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("is_predicateur");
