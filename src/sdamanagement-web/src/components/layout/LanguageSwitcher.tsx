...
export default function LanguageSwitcher() {
  ...
  return (
    <Eyebrow
      asChild
      className="inline-flex items-center gap-2 rounded-[var(--radius)] border border-transparent px-2 py-1 transition-colors hover:border-[var(--hairline-2)] hover:bg-[var(--parchment-2)] hover:text-[var(--ink)]"
    >
      <button
        type="button"
