      ...
      common: {
        ...
        pages: {
          ...
          authDepartments: {
            ...
            deleteConfirmMessage: "Delete \"{{title}}\"? This action cannot be undone.",
            toast: {
            ...
            noActivitiesAdminCta: "Ready to plan? Create your first activity or meeting.",
            subMinistry: {
              noLead: "Aucun responsable",
              selectLead: "Sélectionner un responsable",
              leadValidationError: "L'utilisateur sélectionné n'est pas membre de ce département",
            },
          },
        ...
        meetingForm: {
          ...
          locationNamePlaceholder: "Room name",
          locationAddressPlaceholder: "Street address",
        },
        common: {
          cancel: "Annuler",
          delete: "Delete",
        ...
        pages: {
          ...
          authDepartments: {
            ...
            subMinistry: {
              ...
              leadValidationError: "Selected user is not a member of this department",
            },
          },
          activityDetail: {
            back: "Back",
