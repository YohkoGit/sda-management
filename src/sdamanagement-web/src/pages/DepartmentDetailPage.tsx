...
export default function DepartmentDetailPage() {
  ...
  const {
    ...
    departmentId,
    toastKeys: {
      created: "pages.authDepartments.toast.created",
      meetingCreated: "pages.authDepartments.toast.meetingCreated",
      updated: "pages.authDepartments.toast.updated",
      deleted: "pages.authDepartments.toast.deleted",
      conflictError: "pages.adminActivities.conflictError",
      editLoadError: "pages.authDepartments.toast.loadError",
    },
    onCreated: () => {
  ...
  if (isDeptError) {
    return (
      <div className="mx-auto max-w-7xl px-5 py-12 lg:px-8 lg:py-16">
        ...
        <Eyebrow gilt asChild className="mt-4 inline-block hover:underline">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="shrink-0">
                      {activity.isMeeting ? (
                        <Eyebrow asChild className="inline-flex items-center gap-1.5">
                          <span>
                ...
                >
                  ...
                  {sm.leadUserId && sm.leadFirstName && sm.leadLastName ? (
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <Eyebrow asChild>
                        <span>{sm.leadFirstName} {sm.leadLastName.charAt(0)}.</span>
                      </Eyebrow>
                    </div>
                  ) : (
                    <Eyebrow asChild className="text-[var(--ink-4)]">
                      <span>{t("pages.authDepartments.subMinistry.noLead", "Sans responsable")}</span>
                    </Eyebrow>
                  )}
                </li>
              ))}
