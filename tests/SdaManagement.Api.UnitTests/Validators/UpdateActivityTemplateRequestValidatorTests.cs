...
public class UpdateActivityTemplateRequestValidatorTests
{
    private readonly UpdateActivityTemplateRequestValidator _validator = new();

    private static UpdateActivityTemplateRequest ValidRequest() => new()
    {
